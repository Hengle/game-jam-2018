...
namespace EZCameraShake
{
    ...
    public class CameraShaker : MonoBehaviour
    {
        ...
        private Vector3 _defaultPossition;
        ...
        void Awake()
        {
            _defaultPossition = transform.position;
        ...
        void Update()
        {
            posAddShake = _defaultPossition;// Vector3.zero;
            rotAddShake = _defaultRotation;//Vector3.zero;
